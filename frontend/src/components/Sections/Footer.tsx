    ...
    <div className="flex-between p-5 border-t-[1px] border-[white]">
      ...
      <div className="flex gap-3">
        <Email
          ...
          onClick={() => handleClickLink("mailto:esrafil.elahi@gmail.com")}
        />
        <Github
          className="w-8 h-8 cursor-pointer"
        ...
        <Gitlab
          className="w-8 h-8 cursor-pointer"
          onClick={() => handleClickLink("https://gitlab.com/esrafil")}
        />
        <Linkedin
          className="w-8 h-8 cursor-pointer"
          onClick={() =>
            handleClickLink("https://www.linkedin.com/in/esrafil-elahi/")
          }
        />
      </div>
    </div>
